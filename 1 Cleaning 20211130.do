...
gen Gottsunda=((strpos(stadsdel,"Gottsunda"))==1) //we don't want S.Gottsunda, therefore ==1)
...
merge n:1 postnummer using "C:\Users\ulfha881\PROJECTS\Tove\CRUSH\MyData\AgegroupPopulations.dta",nogenerate assert(match using) keep(match) //age groups in 5-year intervals
