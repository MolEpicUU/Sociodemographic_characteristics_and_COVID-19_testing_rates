...
//Note that this is hospitalizations/postal code/day. We will thus have "duplicates" for each combination of gender/agegroup. Which is what we want.
**********************************HOSPITALIZATIONS****************************************************
//Matching five-digit codes to hospitalizations
cd "\\argos.rudbeck.uu.se\MyGroups$\Gold\CRUSH_Covid\Hospital_UU\CRUSH 06"
import excel "sjukhus inskrivna.xlsx", first clear 
